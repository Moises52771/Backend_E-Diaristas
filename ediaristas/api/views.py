...
from .service.cidades_atendimento__service import listar_diaristas_cidade
from .serializer import diaristas_cidade_serializer
from .pagination import diaristas_cidade_pagination
# Create your views here.

class DiarstasCidadeList(APIView, diaristas_cidade_pagination.DiaristasCidadePagination):
